...
class AppointmentScheduler {
    public LocalDateTime schedule(String appointmentDateDescription) {
        ...
        LocalDateTime localDateTime = LocalDateTime.of(Integer.parseInt(field[0].split("/")[2]), 
                                                       Integer.parseInt(field[0].split("/")[0]), 
                                                       Integer.parseInt(field[0].split("/")[1]), 
                                                       Integer.parseInt(field[1].split(":")[0]), 
                                                       Integer.parseInt(field[1].split(":")[1]), 
                                                       Integer.parseInt(field[1].split(":")[2]));
